#ifndef CUHdbACTIONI_H
#define CUHdbACTIONI_H
...
public:
    ...
    enum Type { HdbFetch = 0, Writer, AttConfig, DbReadProp, DbWriteProp };
     ...
     */
    virtual ~CuHdbActionI() {}


    /*! \brief return a HdbSource object that stores information about the Tango source
     *
     * @return HdbSource, an object storing information on the Tango source
     */
    virtual HdbSource getSource() const  = 0;

    /*! \brief returns the type of CuHdbActionI implemented
     *
